...
Relations de classe :
 ...
 Relation de metaclasses
 
    Object metaclass      = ObjectClass
    Class metaclass       = ClassClass

    ObjectClass metaclass = null (à voir)
    ClassClass metaclass  = null (à voir)
...
a été supprimé, puis repris à nouveau, la suppression entraînant
de nombreux problèmes avec les lookup de methodes

Le système repose donc à nouveau sur deux champs pour les classes :
...
L'installateur effectue automatiquement :
    ...
    5. Liaison classe et métaclasse
...
implique :
    ...
    BClass metaclass = null (a déterminer)
    
Exemple :

    Employee superclass = Person
    Employee metaclass  = EmployeeClass

implique :

    EmployeeClass superclass = PersonClass
    EmployeeClass metaclass  = null
